const fields={salutation:10,name:80,last:80,street:160,houseNumber:30,postalCode:24,city:100,country:100,phone:30,birthDate:10,gender:20}
export function validateDetails(input){
 ...
 if(!['','Herr','Frau'].includes(out.salutation))return null
