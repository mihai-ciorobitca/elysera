...
export const commissionStatus={MISSED:'Verlorene Provision',LOCKED:'Gesperrt',PENDING:'Vorgemerkt',REQUESTED:'Angefragt',APPROVED:'Freigegeben',PAID:'Ausgezahlt'}
