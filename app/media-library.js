...
const aliases={
 ...
 'ugc-creator':'ugc-serum','ugc-morning':'ugc-toner','ugc-eye':'ugc-eye',
...
export const mediaSrcSet=name=>[560,1120,1680].map(width=>`${mediaRoot}${mediaName(name)}-${width}.webp ${width}w`).concat(`${mediaImage(name)} ${mediaName(name)==='hero-desktop'?3840:2160}w`).join(', ')
