...
const editorialNames={'routine-toner':'toner','routine-serum':'serum','routine-eye':'eye','contact-portrait':'contact-support-v2','about-portrait':'../page-editorial-2026/about','science-editorial':'../page-editorial-2026/science'}
...
const textureFilms={'serum-texture':'serum','toner-texture':'toner','eye-texture':'eye'}
export const mediaVideo=name=>textureFilms[name]?`/media/texture-loops-4k/${textureFilms[name]}.mp4`:null
