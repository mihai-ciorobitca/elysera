...
export default function RegistrationHelp(){return <section className="es-registration-help" aria-label="Registrierungshilfe"><h2>Hilfe bei deiner Registrierung</h2>
 <details><summary>Wie erstelle ich mein Konto?</summary><p>Trage deinen Vor- und Nachnamen, deine vollständige Adresse und eine gültige Empfehlung ein. Ergänze deine E-Mail-Adresse und wähle ein Passwort. Nach „Konto erstellen“ wird dein Konto direkt aktiviert und du wirst angemeldet. Ein Bestätigungslink per E-Mail ist dafür nicht erforderlich.</p></details>
 ...
 <details><summary>Eine frühere Registrierung blieb hängen?</summary><p>Nutze „Anmelden“ mit der E-Mail-Adresse und dem Passwort deiner Registrierung. Ein wegen der Bestätigungsmail unvollständiges ELYSERA Konto wird dabei fertig aktiviert. Bei neuen Registrierungen musst du nicht auf eine E-Mail warten.</p></details>
 </section>}
