...
export default function RitualSet(){return <section className="ritual-set-feature" aria-label="Das komplette ELYSERA Set">
  <Link href="/products/peptide-ritual-set" className="ritual-set-photo"><img src={ritualSet.image} alt="Die drei ELYSERA Pflegeprodukte in Navy und Gold auf dunklem Naturstein" loading="eager"/><span className="ritual-set-image-label">ELYSERA · THE COMPLETE RITUAL</span></Link>
