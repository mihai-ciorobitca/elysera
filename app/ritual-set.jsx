...
export default function RitualSet(){return <section className="ritual-set-feature" aria-label="Das komplette ELYSERA Set">
  <Link href="/products/peptide-ritual-set" className="ritual-set-photo"><img src={ritualSet.image} width="1440" height="1920" alt="Die drei ELYSERA Pflegeprodukte in Navy und Gold auf dunklem Naturstein" loading="lazy"/><span className="ritual-set-image-label">ELYSERA · THE COMPLETE RITUAL</span></Link>
  ...
  <div className="ritual-set-purchase"><div className="ritual-set-price"><strong>139 €</strong><span><s>157 €</s> bei Einzelkauf</span><span className="ritual-set-saving">18 € Set-Vorteil</span></div><RoutineSet label="SET VORMERKEN"/><p className="ritual-set-note">Nur auf diesem Gerät speichern · Kein Kauf, keine Bestellung</p></div>
