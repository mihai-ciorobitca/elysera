...
export default function RitualSet(){return <section className="ritual-set-feature" aria-label="Das komplette ELYSERA Set">
  ...
  <div className="ritual-set-purchase"><div className="ritual-set-price"><strong>139 €</strong><span><s>157 €</s> bei Einzelkauf</span><span className="ritual-set-saving">18 € Set-Vorteil</span></div><RoutineSet label="SET VORMERKEN"/><p className="ritual-set-note">Auf diesem Gerät vorgemerkt · Noch keine Bestellung</p></div>
