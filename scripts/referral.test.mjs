...
import {referralInput,referralCode,referralLink} from '../lib/auth/referral-policy.mjs'
...
code='';writes=[];await assert.rejects(()=>insertReferralAccount({...input,verified:false}),/REFERRAL_REQUIRED/);assert.equal(writes.length,0)
